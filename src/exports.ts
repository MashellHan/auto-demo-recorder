/**
 * Re-export barrel for pipeline and config modules.
 *
 * Analytics re-exports live in exports-analytics.ts to keep each barrel
 * file under the 400-line limit. Consumers should continue importing
 * from the package root (`index.ts`) which re-exports everything from
 * both barrel files.
 */
